...
public class RestoreArguments extends BaseArguments {
    ...
    @Option(name = "-bi", aliases = {"--com.com.backup-id"}, metaVar = "com.com.backup ID", usage = "Backup ID to restore from. Normally just the source nodeID, but if the node has replaced another node might be previous nodeID.", required = true)
    public String sourceNodeID;

    @Option(name = "-bb", aliases = {"--com.com.backup-bucket"}, metaVar = "bucket name", usage = "Bucket hosting the snapshot files to restore.", required = true)
