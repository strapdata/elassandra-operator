...
public class StatefulSetWatchService extends WatchService<V1beta2StatefulSet, V1beta2StatefulSetList> {
    ...
    public StatefulSetWatchService(ApiClient apiClient, OperatorConfig config, AppsV1beta2Api appsApi) {
    ...
    protected Call listResources(final String continueToken, final String resourceVersion, final boolean watch) throws ApiException {
        ...
        return appsApi.listNamespacedStatefulSetCall(config.getNamespace(), null, null, continueToken, null, OperatorLabels.toSelector(OperatorLabels.MANAGED), null, resourceVersion, null, watch, null, null);
    }
