...
public class DataCenterPipeline extends K8sWatchPipeline<DataCenter, DataCenterList> {
    ...
    public DataCenterPipeline(ApiClient apiClient, @Named("datacenter-cache") K8sResourceCache<DataCenter> cache, CustomObjectsApi customObjectsApi, OperatorConfig config) {
