...
@Prototype
public class DataCenterDeletionAction {
    private static final Logger logger = LoggerFactory.getLogger(DataCenterDeletionAction.class);
    
    private final K8sResourceUtils k8sResourceUtils;
    private final Key dataCenterKey;
    
    public DataCenterDeletionAction(K8sResourceUtils k8sResourceUtils, @Parameter("dataCenterKey") Key dataCenterKey) {
