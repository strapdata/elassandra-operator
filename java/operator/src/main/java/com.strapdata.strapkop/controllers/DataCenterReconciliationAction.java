...
@Prototype
public class DataCenterReconciliationAction {
    private static final Logger logger = LoggerFactory.getLogger(DataCenterReconciliationAction.class);
    ...
    public DataCenterReconciliationAction(CoreV1Api coreApi, AppsV1beta2Api appsApi,
