...
public abstract class K8sWatchResourceAdapter<ResourceT, ResourceListT> {
    ...
    public abstract Call createApiCall(final boolean watch, final String resourceVersion) throws ApiException;
    public abstract Key getGroupingKey(final ResourceT resource);
