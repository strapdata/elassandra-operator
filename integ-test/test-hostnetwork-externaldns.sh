...
test_start $0
install_elassandra_datacenter $NS cl1 dc1 1 'networking.hostNetworkEnabled=true,networking.externalDns.enabled=true,networking.externalDns.domain=test.strapkube.com,networking.externalDns.root=cl1-dc1'
