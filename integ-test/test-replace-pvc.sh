...
kubectl exec elassandra-cl1-dc1-1-0 -n $NS -- bash -l -c 'nodetool $NODETOOL_OPTS -p $NODETOOL_JMX_PORT flush'
kubectl exec elassandra-cl1-dc1-2-0 -n $NS -- bash -l -c 'nodetool $NODETOOL_OPTS -p $NODETOOL_JMX_PORT flush'
...
kubectl exec elassandra-cl1-dc1-0-0 -n $NS -- bash -l -c "post _updaterouting"
sleep 5
